...
public theorem cuspChosenPositiveRegularBase_one (A : AnalyticData) :
...
public def cuspChosenThirdPeriodFamily (A : AnalyticData) :
...
public theorem cuspChosenThirdPeriodFamily_eq_sweep (A : AnalyticData)
    (r : ℝ) (z : StdTorus 1) :
...
public theorem cuspChosenThirdPeriodFamily_one (A : AnalyticData) :
...
public def cuspChosenThirdPeriodLoop (A : AnalyticData) :
...
public def cuspChosenThirdSweepCentral (A : AnalyticData) :
...
public theorem cuspChosenThirdSweepCentral_loop_realization (A : AnalyticData) :
