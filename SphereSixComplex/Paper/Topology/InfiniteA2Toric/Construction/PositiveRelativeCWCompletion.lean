...
public theorem nonempty_positiveQuotientRelativeCW
  ...
  nonempty_positiveQuotientRelativeCW_of_manifoldBoundary
...
public noncomputable def polarHoneycombConstructionData_of_contractible
  ...
  constructedPolarHoneycombConstructionData W
    (correctedHoneycombHomeomorph W.localWitness.radius_pos) h
    (nonempty_positiveQuotientRelativeCW W).some
