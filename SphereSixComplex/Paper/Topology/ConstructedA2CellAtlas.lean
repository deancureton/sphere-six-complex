...
public def constructedCentralCellMap
    ...
    (n : ℕ) → SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell n →
...
public theorem constructedCentralCellMap_source_eq
    (W : ActualPuncturedCuspCollarWitness N constructedModel)
    (n : ℕ) (i : SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell n) :
...
public def constructedCentralCellSkeleton
  ...
  ⋃ (m < n) (j : SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell m),
...
private theorem constructedCentralCellMap_disjoint_0
    (W : ActualPuncturedCuspCollarWitness N constructedModel)
    (i : Fin 2) (m : ℕ) (j : SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell m)
    (hij : (⟨0, i⟩ : Σ n, SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell n) ≠ ⟨m, j⟩) :
...
private theorem constructedCentralCellMap_disjoint_1
    (W : ActualPuncturedCuspCollarWitness N constructedModel)
    (i : Fin 3) (m : ℕ) (j : SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell m)
    (hij : (⟨1, i⟩ : Σ n, SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell n) ≠ ⟨m, j⟩) :
...
private theorem constructedCentralCellMap_disjoint_2_0
    (W : ActualPuncturedCuspCollarWitness N constructedModel)
    (i : Fin 4) (hi : i = 0) (m : ℕ) (j : SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell m)
    (hij : (⟨2, i⟩ : Σ n, SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell n) ≠ ⟨m, j⟩) :
...
private theorem constructedCentralCellMap_disjoint_2_1
    (W : ActualPuncturedCuspCollarWitness N constructedModel)
    (i : Fin 4) (hi : i = 1) (m : ℕ) (j : SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell m)
    (hij : (⟨2, i⟩ : Σ n, SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell n) ≠ ⟨m, j⟩) :
    Disjoint (constructedCentralCellMap W 2 i '' Metric.ball 0 1)
      (constructedCentralCellMap W m j '' Metric.ball 0 1) := by
  have hp : correctedPositiveTwoCell W '' Metric.ball 0 1 ⊆
...
private theorem constructedCentralCellMap_disjoint_2_2
    (W : ActualPuncturedCuspCollarWitness N constructedModel)
    (i : Fin 4) (hi : i = 2) (m : ℕ) (j : SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell m)
    (hij : (⟨2, i⟩ : Σ n, SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell n) ≠ ⟨m, j⟩) :
    Disjoint (constructedCentralCellMap W 2 i '' Metric.ball 0 1)
      (constructedCentralCellMap W m j '' Metric.ball 0 1) := by
  have hp : correctedPositiveTwoCell W '' Metric.ball 0 1 ⊆
...
private theorem constructedCentralCellMap_disjoint_2_3
    (W : ActualPuncturedCuspCollarWitness N constructedModel)
    (i : Fin 4) (hi : i = 3) (m : ℕ) (j : SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell m)
    (hij : (⟨2, i⟩ : Σ n, SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell n) ≠ ⟨m, j⟩) :
    Disjoint (constructedCentralCellMap W 2 i '' Metric.ball 0 1)
      (constructedCentralCellMap W m j '' Metric.ball 0 1) := by
  have hp : correctedPositiveTwoCell W '' Metric.ball 0 1 ⊆
...
private theorem constructedCentralCellMap_disjoint_2
    (W : ActualPuncturedCuspCollarWitness N constructedModel)
    (i : Fin 4) (m : ℕ) (j : SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell m)
    (hij : (⟨2, i⟩ : Σ n, SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell n) ≠ ⟨m, j⟩) :
    Disjoint (constructedCentralCellMap W 2 i '' Metric.ball 0 1)
      (constructedCentralCellMap W m j '' Metric.ball 0 1) := by
  fin_cases i
...
private theorem constructedCentralCellMap_disjoint_3
    (W : ActualPuncturedCuspCollarWitness N constructedModel)
    (i : Fin 2) (m : ℕ) (j : SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell m)
    (hij : (⟨3, i⟩ : Σ n, SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell n) ≠ ⟨m, j⟩) :
...
private theorem constructedCentralCellMap_disjoint_4
    (W : ActualPuncturedCuspCollarWitness N constructedModel)
    (i : Fin 1) (m : ℕ) (j : SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell m)
    (hij : (⟨4, i⟩ : Σ n, SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell n) ≠ ⟨m, j⟩) :
...
public theorem constructedCentralCellMap_pairwiseDisjoint
    (W : ActualPuncturedCuspCollarWitness N constructedModel) :
    (Set.univ : Set (Σ n, SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.Cell n)).PairwiseDisjoint
...
public def constructedCentralCellAtlas
    (W : ActualPuncturedCuspCollarWitness N constructedModel) :
    SphereSixComplex.Geometry.InfiniteA2Toric.CentralFiber.CellAtlas
