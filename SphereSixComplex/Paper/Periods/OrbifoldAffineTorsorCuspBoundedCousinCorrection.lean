...
public structure CuspBoundedCorrection
...
@[expose] public def CuspBoundedCorrection.globalSection
    {P : OrbifoldAffineDescentData}
    (C : P.CuspBoundedCorrection) : UpperHalfPlane → ℂ :=
  fun z ↦ P.ellipticOne z + C.correction z

public theorem CuspBoundedCorrection.globalSection_holomorphic
    {P : OrbifoldAffineDescentData}
    (C : P.CuspBoundedCorrection) :
    MDiff C.globalSection :=
  P.ellipticOne_holomorphic.add C.holomorphic

public theorem CuspBoundedCorrection.globalSection_one
    {P : OrbifoldAffineDescentData}
    (C : P.CuspBoundedCorrection) (z : UpperHalfPlane) :
...
public theorem CuspBoundedCorrection.globalSection_two
    {P : OrbifoldAffineDescentData}
    (C : P.CuspBoundedCorrection) (z : UpperHalfPlane) :
    C.globalSection (fuchsianSourceAction g₂ • z) =
...
public theorem CuspBoundedCorrection.globalSection_cusp_bounded
    {P : OrbifoldAffineDescentData}
    (C : P.CuspBoundedCorrection) :
...
public theorem hasCuspBoundedSection_of_correction
    (P : OrbifoldAffineDescentData)
    (C : P.CuspBoundedCorrection) :
...
public theorem nonempty_correction_of_hasCuspBoundedSection
    (P : OrbifoldAffineDescentData)
