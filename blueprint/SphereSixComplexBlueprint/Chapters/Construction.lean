...
:::theorem "compact-complex-threefold" (parent := "construction_spine") (lean := "SphereSixComplex.ComplexThreefold, SphereSixComplex.CompletedPaperThreefold, SphereSixComplex.PaperGluingData, SphereSixComplex.Geometry.exists_paperAnalyticData, SphereSixComplex.Geometry.PaperAnalyticData.toPaperGluingData, SphereSixComplex.Geometry.exists_paperGluingData_of_positiveDegreeAssembly, SphereSixComplex.Geometry.PaperAnalyticData.SectionSevenEllipticInteriorMarkedCycleData.ofCuspBoundaryBasisCoordinates, SphereSixComplex.Geometry.PaperAnalyticData.SectionSevenPositiveDegreeGeometricRealization, SphereSixComplex.Geometry.PaperAnalyticData.SectionSevenPositiveDegreeGeometricRealization.positiveDegreeHomologyAssembly, SphereSixComplex.exists_paperGluingData, SphereSixComplex.exists_completedPaperThreefold") (priority := "high")
